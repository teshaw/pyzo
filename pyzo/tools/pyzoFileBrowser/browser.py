...
class Browser(QtWidgets.QWidget):
    ...
    def __init__(self, parent, config, path=None):
        ...
        # Create stash widget (hidden when not in a git repo)
        self._stashWidget = StashWidget(self)
        self._tree.dirChanged.connect(self._stashWidget.updateForPath)
        self._stashWidget.refreshRequested.connect(self._tree.onChanged)
    ...
    def _layout(self):
        ...
        layout.addWidget(self._stashWidget)
